...
| `id` | 必需 | `string` |
| `role` | 必需 | `"developer"` |
| `source` | 必需 | [`MessageSource`](#persistence-type-sha256-91a404dc9d6210cb57f541ad1ff590e9730c38a2fac8551776aef6be07cf9496) |
...
[`Message`](#persistence-type-sha256-a8fe7ebcfa7d0f03a6b93f943c5f8b8f7a632ea851db64e790cf2ea8dee0d7f1) 的数组。
...
来源：[`packages/host/pto-artifact-inspection/src/types.ts:101`](../packages/host/pto-artifact-inspection/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `actionId` | 必需 | `string` |
| `artifactRefs` | 必需 | [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) |
| `recordId` | 必需 | `string` |
| `recordRevision` | 必需 | `string` |
| `requestId` | 必需 | `string` |
| `sessionId` | 必需 | `string` |
| `skill` | 必需 | [`{ name, provider, revision }`](#persistence-type-sha256-8698e8bcb7660a9a8c501adc89cb8be4ad882dacd360c32d82e3a01688c34235) |
| `tool` | 必需 | [`{ name, revision }`](#persistence-type-sha256-7b06b5c4e0068250deec18b0f4a72d7c29fb10b8535c775b45d7939998c43e7d) |
...
来源：[`packages/host/pto-artifact-inspection/src/index.ts:63`](../packages/host/pto-artifact-inspection/src/index.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `form` | 必需 | `"instructions"` |
| `kind` | 必需 | `"pto-artifact-analysis"` |
| `receipt` | 必需 | [`PtoArtifactAnalysisReceipt`](#persistence-type-sha256-3f30852c43bbff8d56eddd3b79333642e56c82589ef43bbbd2e493c2db1bbce6) |
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-7607373d0e2df332f2bea3979f5b5f215554147f7f9dad83640c51b0342df27b) |
...
来源：[`packages/skill/skill/src/index.ts:183`](../packages/skill/skill/src/index.ts)
...
[`UserMessage`](#persistence-type-sha256-040f43129c89d8658f38218a93bc3426ed5e9ae07c80dbdb42e9b8bc9f98b7cd) 的数组。
...
来源：[`packages/api/session-controller/src/types.ts:400`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:20`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:20`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:32`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:8`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/schedule/schedule/src/types.ts:12`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`DeveloperMessage`](#persistence-type-sha256-198dac09368c0215a390ffc7236e87a0b335d8b22654210667aa88d3b4743024) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-abf25e6b6b0eddd1fa7c3db82dff891f856bd61c0cb29939b16241aa1fb308ca) |
| `outcome` | 可选 | `"canceled"` |
...
来源：[`packages/host/pto-artifact-inspection/src/types.ts:108`](../packages/host/pto-artifact-inspection/src/types.ts)
...
来源：[`packages/host/pto-artifact-inspection/src/types.ts:109`](../packages/host/pto-artifact-inspection/src/types.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-a283c0180b6cb729cede8c3ad65d16e7dc025afa316656241706eecf58547894) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-0defa91fb1acb091f4a0c56ba06e967e99be0542e369837d241b76ac9ecb9e23) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-64b0c6667c757c8ae8a036916ddcdb4388ef8a7cdfcbeffe0b0b47248383ae68) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-040f43129c89d8658f38218a93bc3426ed5e9ae07c80dbdb42e9b8bc9f98b7cd) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
