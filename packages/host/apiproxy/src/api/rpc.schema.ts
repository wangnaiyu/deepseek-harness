...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('skill-catalog-unavailable'), message: z.string(), details: z.object({ reason: z.string().optional() }) }),
  z.object({ code: z.literal('skill-unavailable'), message: z.string(), details: z.object({ name: z.string() }) }),
