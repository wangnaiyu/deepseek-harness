...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_subagent_models', 'load_workspace_dependencies', 'lsp', 'plugin_manager', 'present', 'pto_experiment_compare', 'pto_experiment_get', 'pto_experiment_list', 'pto_experiment_plan',
      'pto_run_discover', 'pto_run_inspect', 'pwsh', 'pwsh', 'ralph',
