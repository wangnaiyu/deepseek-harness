...
export function ToolDetails({
  block, cwd, useConnectionGeneration, t, renderSlot,
}: Pick<ToolDetailsProps, 'block' | 'cwd' | 'useConnectionGeneration' | 't' | 'renderSlot'>) {
  ...
  return renderSlot('tool.result.detailview', owner, {
    ...
    fallback: (
      <GenericToolDetails
        block={block}
        cwd={cwd}
        useConnectionGeneration={useConnectionGeneration}
        t={t}
      />
    ),
  })
