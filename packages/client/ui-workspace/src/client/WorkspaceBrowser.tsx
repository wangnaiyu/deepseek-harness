...
import {
  Button, IconCloseFill14, IconNewChatOutline16, IconPersonalizationOutline16,
...
type SessionTreeProps = Pick<
  ...
  'useSessions' | 'startSession' | 'startUnassignedSession' | 'open' | 'forkSession'
...
function SessionTree({
  useSessions, startSession, startUnassignedSession, open, forkSession, workspaces, archivedSessionIds,
