...
| [`session-format-v3-to-v4/`](session-format-v3-to-v4/README.md) | V3 body conversion, reference remapping, and released V4 codec | library — no ctx key |
| [`session-format-v4-to-v5/`](session-format-v4-to-v5/README.md) | V5 codec and explicit compatibility for both historical V4 lineages | library — no ctx key |
