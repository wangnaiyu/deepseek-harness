...
| [`session-format-v3-to-v4/`](session-format-v3-to-v4/README.zh.md) | V3 正文转换、引用重映射及 V4 编解码器 | 库——无 ctx 键 |
| [`session-format-v4-to-v5/`](session-format-v4-to-v5/README.zh.md) | V5 编解码器与两条历史 V4 lineage 的显式兼容 | 库——无 ctx 键 |
