...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-brand-pto': { kind: 'none', reason: 'Browser-side presentation occupants; registers nothing model-facing.' },
  ...
  'packages/client/ui-composer-catalog': { kind: 'none', reason: 'Browser-side draft discovery projection; it only inserts text and does not submit or load capabilities.' },
  ...
  'packages/host/composer-catalog': { kind: 'none', reason: 'Host-side read-only draft capability projection; registers nothing model-facing.' },
