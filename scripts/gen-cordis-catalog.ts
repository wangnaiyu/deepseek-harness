...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  planMode: 'plan.md',
  ptoExperiments: 'pto-experiments.md',
  ptoExperimentDashboard: 'pto-experiments.md',
  ptoArtifactInspection: 'pto-experiments.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PtoExperimentList: 'pto-experiments.md',
  PtoExperimentMetric: 'pto-experiments.md',
  PtoExperimentCompareInput: 'pto-experiments.md',
  PtoExperimentComparison: 'pto-experiments.md',
  PtoExperimentComparisonDimension: 'pto-experiments.md',
  PtoExperimentExecuteInput: 'pto-experiments.md',
  PtoExperimentExecutionScope: 'pto-experiments.md',
  PtoExperimentPlanInput: 'pto-experiments.md',
  PtoExperimentScope: 'pto-experiments.md',
  PtoExperimentView: 'pto-experiments.md',
  PtoExperimentDashboardRequest: 'pto-experiments.md',
  PtoExperimentDashboardExecuteRequest: 'pto-experiments.md',
  PtoExperimentDashboardCancelRequest: 'pto-experiments.md',
  PtoExperimentDashboardCancelResult: 'pto-experiments.md',
  PtoExperimentDashboardExecutionActivity: 'pto-experiments.md',
  PtoExperimentDashboardEntry: 'pto-experiments.md',
  PtoExperimentDashboardMetric: 'pto-experiments.md',
  PtoExperimentDashboardSnapshot: 'pto-experiments.md',
  ...
  FsDirectoryReservation: 'filesystem.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PtoArtifactAnalysisAdmitRequest: 'PTO artifact wire payload is owned by packages/host/pto-artifact-inspection/src/types.ts',
  PtoArtifactAnalysisReceipt: 'PTO artifact wire payload is owned by packages/host/pto-artifact-inspection/src/types.ts',
  PtoArtifactCloseRequest: 'PTO artifact wire payload is owned by packages/host/pto-artifact-inspection/src/types.ts',
  PtoArtifactCloseResult: 'PTO artifact wire payload is owned by packages/host/pto-artifact-inspection/src/types.ts',
  PtoArtifactInspectRequest: 'PTO artifact wire payload is owned by packages/host/pto-artifact-inspection/src/types.ts',
  PtoArtifactOpenRequest: 'PTO artifact wire payload is owned by packages/host/pto-artifact-inspection/src/types.ts',
  PtoArtifactRecordView: 'PTO artifact wire payload is owned by packages/host/pto-artifact-inspection/src/types.ts',
  PtoArtifactViewerHandle: 'PTO artifact wire payload is owned by packages/host/pto-artifact-inspection/src/types.ts',
  QualifiedSkillIdentity: 'provider-qualified Skill identity is owned by packages/skill/skill/README.md',
